...
# The mixer lifecycle (probe, warm, idle release, hotplug reinit) lives in
# purple_tui/mixer.py; its names stay importable from here, looked up live.
from .. import mixer
...
class MusicGrid(Widget):
    ...
    def __init__(self) -> None:
        ...
        self._instrument_sounds: dict[str, dict[str, mixer.pygame.mixer.Sound]] = {}
        # Percussion sounds (shared across instruments)
        self._percussion_sounds: dict[str, mixer.pygame.mixer.Sound] = {}
        self._percussion_loaded = False
        self._letter_sounds: dict[str, mixer.pygame.mixer.Sound] = {}
        ...
        self._sounds_generation = mixer.mixer_generation()
    ...
    def _ensure_letter_sounds_loaded(self) -> None:
        ...
        self._drop_stale_sounds()
        if self._letter_sounds_loaded or not mixer.mixer_ready_for_play():
            return
    ...
    def cleanup_sounds(self) -> None:
        ...
        if mixer._MIXER_READY:
            try:
                mixer.pygame.mixer.stop()
            except mixer.pygame.error:
                pass
        self._clear_sound_caches()
...
class MusicMode(Container, can_focus=True):
    ...
    def on_mount(self) -> None:
        ...
        _threading.Thread(target=mixer.warm_mixer, daemon=True, name="mixer-warm").start()
        self.focus()
        self._update_hint()
