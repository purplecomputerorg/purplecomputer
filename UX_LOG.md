...
- Room title in status bar now truly centered over viewport regardless of indicator widths. Code mode layout is more compact: status bar, viewport, and code panel share borders with no gaps, allowing a ~6% larger font.
