...
from purple_tui.canvas import harness  # noqa: F401  (sets SDL dummy drivers)
from purple_tui.canvas.gfx import Gfx
from purple_tui.canvas.sdl_input import pump
