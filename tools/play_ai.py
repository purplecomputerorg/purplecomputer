...
def main():
    ...
    parser.add_argument("--install", action="store_true",
                        help="Write to purple_tui/demo/ai_generated_play.py")
    ...
    if args.json:
        ...
        if args.install:
            install_path = Path(__file__).parent.parent / "purple_tui" / "demo" / "ai_generated_play.py"
            content = f'''"""AI-generated Play Mode composition: {title}

Generated by: python tools/play_ai.py "{args.goal}"
"""

from .script import PlayKeys, Comment, Pause, SwitchMode, ClearAll
