...
- **Bulleted code-panel hints**: The cycling "Try:" hints in the Art and Music code panels now group two or three short commands per line with the same "•" bullet style Play uses (e.g. "red • green 10 • spin"), instead of one command per line. Genuinely multi-step examples stay on their own line.
