...
export PURPLE_ZOOM_EVENTS="${PURPLE_ZOOM_EVENTS:-}"
export PURPLE_RECORD_READY_FILE="${PURPLE_RECORD_READY_FILE:-}"
export PURPLE_RECORD_GO_FILE="${PURPLE_RECORD_GO_FILE:-}"
export PURPLE_RECORD_DONE_FILE="${PURPLE_RECORD_DONE_FILE:-}"
