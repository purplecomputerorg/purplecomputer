...
class TestEnsureTerminalSize:
    ...
    def test_adjusts_font_when_too_few_rows(self):
        ...
        def fake_terminal_size():
            ...
            return os.terminal_size((146, 38))  # Correct after adjustment
        ...
        # min(24.0 * 120/146, 24.0 * 34/38) = min(19.73, 21.47) -> floor_half to 19.5
        mock_run.assert_called_once()
        args = mock_run.call_args[0][0]
        assert args == ['alacritty', 'msg', 'config', 'font.size=19.5']
        os.unlink(path)
